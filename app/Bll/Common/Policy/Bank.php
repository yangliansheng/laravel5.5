...
class Bank{
     ...
     * @return mixed|string
     */
    public static function getBankByCard($card){
        ...
        if (isset(self::$bankList[$card_8])) {
            return ['status' => 1, 'bank' => self::$bankList[$card_8]];
        } elseif (isset(self::$bankList[$card_6])) {
            return ['status' => 1, 'bank' => self::$bankList[$card_6]];
        } elseif (isset(self::$bankList[$card_5])) {
            return ['status' => 1, 'bank' => self::$bankList[$card_5]];
        } elseif (isset(self::$bankList[$card_4])) {
            return ['status' => 1, 'bank' => self::$bankList[$card_4]];
        }else{
            return ['status' => 0, 'bank' => '未知'];
        }
    }
}